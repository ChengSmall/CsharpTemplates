...
namespace Cheng.Algorithm.Sorts.Comparers
{
    ...
    public sealed class ChineseCharparer : Comparer<char>
    {
        ...
        public ChineseCharparer(IDictionary<char, string> chineseDict, IComparer<char> comparer) : this(chineseDict, comparer, null, null)
        {
        }
        ...
        /// <param name="chineseDict">该参数表示一个汉字字符映射字典，key表示要查的汉字，value表示该汉字拼音</param>
        /// <exception cref="ArgumentNullException">字典为null</exception>
        public ChineseCharparer(IDictionary<char, string> chineseDict) : this(chineseDict, null, null, null)
        {
        }
        ...
        /// <param name="pinComparer">该参数用于在比较汉字拼音字符串时使用的比较器，null表示默认比较器</param>
        /// <exception cref="ArgumentNullException">字典为null</exception>
        public ChineseCharparer(IDictionary<char, string> chineseDict, IComparer<char> comparer, IComparer<string> pinComparer) : this(chineseDict, comparer, pinComparer, null)
        {
        }
        ...
        {
            f_init(new System.Collections.ObjectModel.ReadOnlyDictionary<char, string>(chineseDict), comparer, pinComparer, pinEqualComparer);
        }
        ...
        /// <param name="comparer">该参数用于当检测到非汉字字符（也就是字典内不存在的值）时使用的字符比较器，null表示默认比较器</param>
        /// <exception cref="ArgumentNullException">字典为null</exception>
        public ChineseCharparer(IReadOnlyDictionary<char, string> chineseDict, IComparer<char> comparer)
        {
        ...
        /// <param name="chineseDict">该参数表示一个汉字字符映射字典，key表示要查的汉字，value表示该汉字拼音</param>
        /// <exception cref="ArgumentNullException">字典为null</exception>
        public ChineseCharparer(IReadOnlyDictionary<char, string> chineseDict) : this(chineseDict, null)
        {
        }
        ...
        /// <param name="pinComparer">该参数用于在比较汉字拼音字符串时使用的比较器，null表示默认比较器</param>
        /// <exception cref="ArgumentNullException">字典为null</exception>
        public ChineseCharparer(IReadOnlyDictionary<char, string> chineseDict, IComparer<char> comparer, IComparer<string> pinComparer)
        {
        ...
        /// <param name="pinEqualComparer">当拼音比较完毕后，如果两个字符相等，则使用该比较器比较；null表示默认实现的字符比较器</param>
        /// <exception cref="ArgumentNullException">字典为null</exception>
        public ChineseCharparer(IReadOnlyDictionary<char, string> chineseDict, IComparer<char> comparer, IComparer<string> pinComparer, IComparer<char> pinEqualComparer)
        {
        ...
        private void f_init(IReadOnlyDictionary<char, string> chineseDict, IComparer<char> comparer, IComparer<string> pin, IComparer<char> pinEqualInvoke)
        {
        ...
        private IReadOnlyDictionary<char, string> p_hashChars;
        ...
        public sealed override int Compare(char x, char y)
        {
            ...
            if (!(p_hashChars.TryGetValue(x, out left) && p_hashChars.TryGetValue(y, out right)))
            {
                // 存在无拼音字符
                return p_defaultChar.Compare(x, y);
            }
