...
namespace Cheng.Algorithm.Pathfindings.GridPathfindings
{
    ...
    /// A* 寻路算法
    /// </summary>
    public sealed class AStarGridPathfinding : BaseGridPathfinding
    {
        ...
        /// 实例化算法对象
        /// </summary>
        public AStarGridPathfinding() : this(0)
        {
        }
        ...
        /// </param>
        public AStarGridPathfinding(int minHeuristicCost)
        {
        ...
        public override bool Calculation(IGridMap map, PointInt2 startPos, PointInt2 endPos, ICollection<PointInt2> append)
        {
            ...
            long hStart = Heuristic(startPos.x, startPos.y, endPos.x, endPos.y, map.CanDiagonally);
            ...
            while (!openList.IsEmpty)
            {
                ...
                for (int i = 0; i < dirX.Length; i++)
                {
                    ...
                    if (newG < gScore[nx, ny])
                    {
                        ...
                        long h = Heuristic(nx, ny, endPos.x, endPos.y, map.CanDiagonally);
        ...
        private long Heuristic(int x1, int y1, int x2, int y2, bool canDiagonally)
        {
