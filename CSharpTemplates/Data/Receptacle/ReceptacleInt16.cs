...
using ty = System.Int16;
using Rec = Cheng.DataStructure.Receptacles.ReceptacleInt16;
...
namespace Cheng.DataStructure.Receptacles
{
    ...
    public readonly struct ReceptacleInt16 : IEquatable<ReceptacleInt16>, IComparable<ReceptacleInt16>, IHashCode64
    {
        ...
        public bool SubMinZero(short value, out Rec reValue)
        {
            var v = this.value - value;
            ...
            reValue = new Rec((short)v, maxValue);
            return flag;
        }
        ...
        public bool SubMin(short subValue, short minValue, out Rec reValue)
        {
