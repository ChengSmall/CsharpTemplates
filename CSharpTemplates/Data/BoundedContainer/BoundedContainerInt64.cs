...
using BC = Cheng.DataStructure.BoundedContainers.BoundedContainerInt64;
using bc = System.Int64;
...
namespace Cheng.DataStructure.BoundedContainers
{
    ...
    public readonly struct BoundedContainerInt64 : IEquatable<BC>, IComparable<BC>, IHashCode64
    {
        ...
        public BoundedContainerInt64(bc value, bc min, bc max)
        {
            this.value = value;
            this.min = min;
            this.max = max;
        ...
        /// <param name="min">指定最小值</param>
        /// <param name="max">指定最大值</param>
        public BoundedContainerInt64(bc min, bc max)
        {
            this.value = min;
            this.min = min;
            this.max = max;
