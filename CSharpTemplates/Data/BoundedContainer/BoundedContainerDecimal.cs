...
using BC = Cheng.DataStructure.BoundedContainers.BoundedContainerDecimal;
using bc = System.Decimal;
...
namespace Cheng.DataStructure.BoundedContainers
{
    ...
    public readonly struct BoundedContainerDecimal : IEquatable<BC>, IComparable<BC>, IHashCode64
    {
        ...
        public BoundedContainerDecimal(bc value, bc min, bc max)
        {
            this.value = value;
            this.min = min;
            this.max = max;
        ...
        /// <param name="min">指定最小值</param>
        /// <param name="max">指定最大值</param>
        public BoundedContainerDecimal(bc min, bc max)
        {
            this.value = min;
            this.min = min;
            this.max = max;
        ...
        public bool Add(bc value, out BC reValue)
        {
            ...
            reValue = new BC(re, this.min, this.max);
            return reb;
        }
