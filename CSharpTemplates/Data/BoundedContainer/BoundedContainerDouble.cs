...
using BC = Cheng.DataStructure.BoundedContainers.BoundedContainerDouble;
using bc = System.Double;
...
namespace Cheng.DataStructure.BoundedContainers
{
    ...
    public readonly struct BoundedContainerDouble : IEquatable<BC>, IComparable<BC>, IHashCode64
    {
        ...
        public BoundedContainerDouble(bc value, bc min, bc max)
        {
            this.value = value;
            this.min = min;
            this.max = max;
        ...
        /// <param name="min">指定最小值</param>
        /// <param name="max">指定最大值</param>
        public BoundedContainerDouble(bc min, bc max)
        {
            this.value = min;
            this.min = min;
            this.max = max;
