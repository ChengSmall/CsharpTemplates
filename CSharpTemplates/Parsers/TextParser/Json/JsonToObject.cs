...
namespace Cheng.Json
{
    ...
    /// </summary>
    public abstract class JsonToObject : IJsonToObject, System.Collections.Generic.IReadOnlyList<Type>
    {
        ...
        int System.Collections.Generic.IReadOnlyCollection<Type>.Count => TypeCount;
