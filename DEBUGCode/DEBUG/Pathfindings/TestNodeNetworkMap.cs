...
namespace Cheng.DEBUG
{
    ...
    public sealed class TestNodeNetworkMap : INodeNetworkMap
    {
        ...
        public TestNodeNetworkMap(int count)
        {
            ...
            {
                p_nodeList.Add(new ANode("m:" + i.ToString("X")));
            }
        }
        ...
        {
            p_nodeList[FindIndexByID(nid1)].AddNode(p_nodeList[FindIndexByID(nid2)], cost);
            p_nodeList[FindIndexByID(nid2)].AddNode(p_nodeList[FindIndexByID(nid1)], cost);
        }
